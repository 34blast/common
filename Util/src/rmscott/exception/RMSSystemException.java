 ...
 */
public class RMSSystemException extends LoggableException {
	 ...
	 * @param pIsLogged
	 */
	public RMSSystemException(String pMessage, boolean pIsLogged) {
		super(pMessage);
	 ...
	 * @param pIsLogged
	 */
	public RMSSystemException(Throwable pThr, boolean pIsLogged) {
		super(pThr);
		this.setLogged(pIsLogged);
	}
